...
- Anında gönderir
- **Her seçili account, TÜM seçili kişilere gönderir**

Örnek:
- 100 kişi seçildi
- 2 account seçildi (Dan, Ben)
- Sistem: Dan 100 kişiye, Ben 100 kişiye gönderir
- **Toplam: 200 mail**
...
5. **🚀 Hemen Gönder**
6. Her account 200 kişiye gönderir
7. **Toplam: 800 mail - her mail farklı imzayla!**
...
### Account'lar nasıl çalışır?

**Her account, TÜM kişilere gönderir:**

Örnek: 100 kişi, 3 account → Her account 100 kişiye gönderir
**Toplam: 300 mail**

Bu sayede her kişi, farklı sender'lardan aynı mesajı alır (farklı imzalarla).
...
### Gönderilen mailler neden "Sent" klasöründe görünmüyor?

**Normal!** ZeptoMail API ile gönderilen mailler **otomatik olarak Sent klasörüne düşmez**. Bu ZeptoMail'in bir özelliği:

- API gönderimler → Sent'e kaydedilmez
- Web/SMTP gönderimler → Sent'e kaydedilir

Mail **gönderilmiştir** ama sent klasöründe görünmez. Alıcının inbox'ına düşmesi yeterli!
